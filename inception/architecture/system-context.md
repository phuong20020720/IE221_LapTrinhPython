...
| Thành phần | Vai trò |
|---|---|
| Patient | Xem bác sĩ, đặt và tra cứu lịch hẹn; không bắt buộc đăng nhập |
...
4. API tạo Appointment với `PENDING_ASSIGNMENT` nếu chưa chọn bác sĩ.
5. API trả `booking_code` để tra cứu.
